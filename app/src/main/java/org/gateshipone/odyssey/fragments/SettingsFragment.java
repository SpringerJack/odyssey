...
public class SettingsFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        openEqualizer.setOnPreferenceClickListener(preference -> {
            ...
            try {
                requireActivity().startActivity(startEqualizerIntent);
                ...
                equalizerNotFoundDlg.show(((AppCompatActivity) requireContext()).getSupportFragmentManager(), "EqualizerNotFoundDialog");
            }
        ...
        backwardsSeek.setOnPreferenceClickListener(preference -> {
            ...
            dialog.show(((AppCompatActivity) requireContext()).getSupportFragmentManager(), "Volume steps");
            return true;
        });
        ...
        randomIntelligencePreference.setOnPreferenceClickListener(preference -> {
            ...
            dialog.show(((AppCompatActivity) requireContext()).getSupportFragmentManager(), "Random Intelligence dialog");
            return true;
        });
    }
