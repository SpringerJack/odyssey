...
public class AlbumTracksFragment extends OdysseyRecyclerFragment<TrackModel, GenericViewItemHolder> implements CoverBitmapLoader.CoverBitmapReceiver, ArtworkManager.onNewAlbumImageListener, OdysseyRecyclerView.OnItemClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mHideArtwork = sharedPreferences.getBoolean(requireContext().getString(R.string.pref_hide_artwork_key),
                requireContext().getResources().getBoolean(R.bool.pref_hide_artwork_default));
    ...
    GenericViewModel<TrackModel> getViewModel() {
        return new ViewModelProvider(
                this,
                new TrackViewModel.TrackViewModelFactory(
    ...
    public void onResume() {
        ...
        ArtworkManager.getInstance(requireContext()).registerOnNewAlbumImageListener(this);
    }
    ...
    public void onPause() {
        ...
        ArtworkManager.getInstance(requireContext()).unregisterOnNewAlbumImageListener(this);
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.action_reset_artwork) {
            mToolbarAndFABCallback.setupToolbar(mAlbum.getAlbumName(), false, false, false);
            ArtworkManager.getInstance(requireContext()).resetImage(mAlbum);
            return true;
